...
public class DailyAnaylyticsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daily_anaylytics);
    ...
    private void getTotalDailyTransportExpense() {
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(DailyAnaylyticsActivity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    ...
                    Toast.makeText(DailyAnaylyticsActivity.this,"Child does not exist", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() ){
                    ...
                    Toast.makeText(DailyAnaylyticsActivity.this, "setStatusAndImageResource Errors", Toast.LENGTH_SHORT).show();
                }
            }
